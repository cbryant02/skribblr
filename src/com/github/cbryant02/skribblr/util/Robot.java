...
/**
 * Patched Robot class.
 * Entirely disables auto delay, because:<br/>
 *   a. It's not needed for skribblr, SkribblRobot handles it<br/>
 *   b. This class was badly written and does not pass {@link InterruptedException}s
 *      up the method call chain
 *
 * <p>
 *
...
public class Robot extends java.awt.Robot {
     ...
     */
    private void afterEvent() throws InterruptedException {}
     ...
     */
    private void autoDelay() throws InterruptedException {}
